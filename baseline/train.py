...
parser.add_argument('--train_image_dir', default='/root/dreamNav/pairUAV/train_tour', type=str, help='path to train images dir')
parser.add_argument('--train_json_dir', default='/root/dreamNav/pairUAV/train', type=str, help='path to train json dir')
parser.add_argument('--train_match_dir', default='/root/dreamNav/step1/train_matches_data', type=str, help='path to train matches dir')
parser.add_argument('--test_image_dir', default='/root/dreamNav/pairUAV/test_tour', type=str, help='path to test images dir')
parser.add_argument('--test_json_dir', default='/root/dreamNav/pairUAV/test', type=str, help='path to test json dir')
parser.add_argument('--test_match_dir', default='/root/dreamNav/step1/test_matches_data', type=str, help='path to test matches dir')
parser.add_argument('--test_output_txt', default='/root/dreamNav/step1/test_predict_output.txt', type=str, help='path to write ordered test predictions')
